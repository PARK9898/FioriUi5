sap.ui.define(
  ...
  (Controller, ODataModel, MessageToast, JSONModel) => {
    ...
    return Controller.extend("project65.controller.Main", {
      onInit() {
        var oModel = new ODataModel("/sap/opu/odata/sap/ZDCFI_GW_002_SRV/");
        this.oRouter = this.getOwnerComponent().getRouter();
        this.oRouter
          .getRoute("RouteMain")
          .attachPatternMatched(this._onPatternMatched, this); // 라우팅 세팅팅
        ...
        setTimeout(() => {
          this.byId("yearComboBox").setSelectedKey(currentYear.toString());
          this.byId("monthComboBox").setSelectedKey(currentMonth.toString());
        }, 0);
      },
      onSearch: function () {
        var totalGain = 0;
