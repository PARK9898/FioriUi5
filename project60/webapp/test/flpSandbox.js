		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#exratecomparewithvouitemproject60-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"exratecomparewithvouitemproject60-display": {
								"semanticObject": "exratecomparewithvouitemproject60",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exratecomparewithvouitem.project60",
									"url": sap.ui.require.toUrl("exratecomparewithvouitem/project60")
								}
							}
						}
					}
