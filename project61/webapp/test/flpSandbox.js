		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#exratewithvouitemproject61-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"exratewithvouitemproject61-display": {
								"semanticObject": "exratewithvouitemproject61",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exratewithvouitem.project61",
									"url": sap.ui.require.toUrl("exratewithvouitem/project61")
								}
							}
						}
					}
