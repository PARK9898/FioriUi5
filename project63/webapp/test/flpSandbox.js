					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Exrate With Voucher Item",
									"targetURL": "#project63-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"project63-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project63",
									"url": sap.ui.require.toUrl("project63")
								}
							}
						}
					}
